...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/round-base-8667)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/round-base-8667
```

A live public deployment of this template is available at [https://round-base-8667.templates.workers.dev](https://round-base-8667.templates.workers.dev)
